...
const VolkovPicture2Info = (props) => {
    ...
    return (
        <div className='volkov-picture2-info'>
            ...
            <div className="volkov-main-picture2-info-text-container">
...
export default VolkovPicture2Info;