...
const KuprinPicture1 = (props) => {
    ...
    return (
        <div className='kuprin-artist-picture1'>
            <img src={holst} alt="" className='holst'/>
            <div className="pins-container">
                <img className='pins' src={pins} alt="" />
            </div>
            <div className="kuprin-main-picture1-container">
                <div className="kuprin-header-text-picture1">
                    «Натюрморт с синим подносом» (1914)
                </div>
                <div className="kuprin-picture1-image">
                    <div className='kuprin-picture1' style={{
