...
const SokolovPicture1 = (props) => {
    ...
    return (
        <div className='sokolov-artist-picture1'>
            <img src={holst} alt="" className='holst'/>
            <div className="pins-container">
                <img className='pins' src={pins} alt="" />
            </div>
            <div className="sokolov-main-picture1-container">
                <div className="sokolov-header-text-picture1">
                    «Свадебный поезд» (1850-е)
                </div>
                <div className="sokolov-picture1-image">
                    <div className='sokolov-picture1' style={{
...
export default SokolovPicture1;