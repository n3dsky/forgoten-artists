...
const SokolovPicture2 = (props) => {
    ...
    return (
        <div className='scotti-artist-picture2'>
            <img src={holst} alt="" className='holst'/>
            <div className="pins-container">
                <img className='pins' src={pins} alt="" />
            </div>
            <div className="scotti-main-picture2-container">
                <div className="scotti-header-text-picture1">
                    «Ночь на Ивана Купалу»
                </div>
                <div className="scotti-picture2-image">
                    <div className='scotti-picture2' style={{
...
export default SokolovPicture2;