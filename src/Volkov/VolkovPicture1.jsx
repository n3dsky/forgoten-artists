...
const VolkovPicture1 = (props) => {
    ...
    return (
        <div className='volkov-artist-picture1'>
            <img src={holst} alt="" className='holst'/>
            <div className="pins-container">
                <img className='pins' src={pins} alt="" />
            </div>
            <div className="volkov-main-picture1-container">
                <div className="soroka-header-text-picture1">
                    «Октябрь» (1883 год)
                </div>
                <div className="volkov-picture1-image">
                    <div className='volkov-picture1' style={{
