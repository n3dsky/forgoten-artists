...
const ArgunovPicture2 = (props) => {
    ...
    return (
        <div className='argunov-artist-picture2'>
            <img src={holst} alt="" className='holst'/>
            <div className="pins-container">
                <img className='pins' src={pins} alt="" />
            </div>
            <div className="argunov-main-picture2-container">
                <div className="argunov-header-text-picture1">
                    «Портрет графини Варвары Шереметевой» (1760-е)
                </div>
                <div className="argunov-picture2-image">
                    <div className='argunov-picture2' style={{
...
export default ArgunovPicture2;