...
const SorokaPicture1 = (props) => {
    ...
    return (
        <div className='soroka-artist-picture1'>
            <img src={holst} alt="" className='holst'/>
            <div className="pins-container">
                <img className='pins' src={pins} alt="" />
            </div>
            <div className="soroka-main-picture1-container">
                <div className="soroka-header-text-picture1">
                    «Кабинет в Островках» (1840-е)
                </div>
                <div className="soroka-picture1-image">
                    <div className='soroka-picture1' style={{
