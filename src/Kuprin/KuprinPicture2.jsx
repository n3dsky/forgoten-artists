...
const KuprinPicture2 = (props) => {
    ...
    return (
        <div className='kuprin-artist-picture2'>
            <img src={holst} alt="" className='holst'/>
            <div className="pins-container">
                <img className='pins' src={pins} alt="" />
            </div>
            <div className="kuprin-main-picture2-container">
                <div className="kuprin-header-text-picture1">
                    «Натюрморт с трубкой» (1917)
                </div>
                <div className="kuprin-picture2-image">
                    <div className='kuprin-picture2' style={{
