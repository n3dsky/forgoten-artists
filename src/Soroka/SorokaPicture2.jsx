...
const SorokaPicture2 = (props) => {
    ...
    return (
        <div className='soroka-artist-picture2'>
            <img src={holst} alt="" className='holst'/>
            <div className="pins-container">
                <img className='pins' src={pins} alt="" />
            </div>
            <div className="soroka-main-picture2-container">
                <div className="soroka-header-text-picture1">
                    «Рыбаки» (1840-е)
                </div>
                <div className="soroka-picture2-image">
                    <div className='soroka-picture2' style={{
