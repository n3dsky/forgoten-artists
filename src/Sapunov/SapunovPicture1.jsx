...
const SapunovPicture1 = (props) => {
    ...
    return (
        <div className='sapunov-artist-picture1'>
            <img src={holst} alt="" className='holst'/>
            <div className="pins-container">
                <img className='pins' src={pins} alt="" />
            </div>
            <div className="sapunov-main-picture1-container">
                <div className="sapunov-header-text-picture1">
                    «Голубые гортензии» (1908)
                </div>
                <div className="sapunov-picture1-image">
                    <div className='sapunov-picture1' style={{
...
export default SapunovPicture1;