...
const CleverPicture1 = (props) => {
    ...
    return (
        <div className='clever-artist-picture1'>
            <img src={holst} alt="" className='holst'/>
            <div className="pins-container">
                <img className='pins' src={pins} alt="" />
            </div>
            <div className="clever-main-picture1-container">
                <div className="clever-header-text-picture1">
                    «Заброшенная мельница» (1890)
                </div>
                <div className="clever-picture1-image">
                    <div className='clever-picture1' style={{
